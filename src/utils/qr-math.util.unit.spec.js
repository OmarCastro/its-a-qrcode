...
test('validate Galois field exponent table', ({ expect }) => {
  expect(new Array(256).fill(1).map((_, index) => gexp(index))).toEqual(
    [
...
test('validate Galois field logarithmic table', ({ expect }) => {
  expect([...new Array(255).fill(1).map((_, index) => glog(index + 1))]).toEqual(
    [
